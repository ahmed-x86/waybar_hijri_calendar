...
def get_hijri_date():
    ...
    if today_str in cache:
        ...
        return h_data['day'], h_data['month_name'], h_data['year'], h_data['weekday_ar'], py_weekday, month_length
...
def main():
    ...
    day, month_name, year, weekday_ar, py_weekday, month_length = result
